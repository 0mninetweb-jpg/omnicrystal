...
export function Layout({
  ...
  return (
    <div className="relative min-h-screen overflow-x-clip bg-transparent text-slate-900">
      <div className="pointer-events-none fixed inset-x-0 top-0 z-[-3] h-[480px] bg-[radial-gradient(circle_at_18%_20%,rgba(20,83,232,0.12),transparent_42%),radial-gradient(circle_at_82%_0%,rgba(217,93,116,0.12),transparent_32%)]" />
      <div className="pointer-events-none fixed left-[-120px] top-[16vh] z-[-2] h-[320px] w-[320px] rounded-full bg-[rgba(20,83,232,0.08)] blur-[110px]" />
      <div className="pointer-events-none fixed bottom-[-120px] right-[-90px] z-[-2] h-[340px] w-[340px] rounded-full bg-[rgba(217,93,116,0.08)] blur-[120px]" />

      <div className={cn('mx-auto flex min-h-screen w-full max-w-[1680px] flex-col', isDesktop && 'xl:flex-row')}>
        {isDesktop && (
          <aside className="hidden w-[330px] shrink-0 xl:block">
            <div className="px-5 py-5">
              <div className="sidebar-shell sticky top-4 flex max-h-[calc(100vh-2rem)] min-h-0 flex-col rounded-[36px] px-5 py-5">
              <div className="rounded-[28px] bg-[linear-gradient(145deg,rgba(255,255,255,0.94),rgba(255,255,255,0.68))] px-4 py-4 shadow-[0_22px_48px_rgba(15,23,42,0.08)]">
                <div className="flex items-center gap-4">
                <div className="flex h-[52px] w-[52px] items-center justify-center rounded-[20px] bg-slate-950 text-white shadow-[0_18px_35px_rgba(15,23,42,0.18)]">
                ...
                <div className="mt-4 rounded-[20px] bg-slate-950 px-4 py-3 text-sm leading-6 text-slate-200">
              ...
              <div className="mt-7 min-h-0 flex-1 overflow-y-auto pr-1 no-scrollbar">
                <div className="space-y-6">
                  ...
                  {NAV_ITEMS.map((item) => (
                    <button
                      ...
                      className={cn(
                        ...
                        currentView === item.id
                          ? 'bg-slate-950 text-white shadow-[0_20px_38px_rgba(15,23,42,0.18)]'
                          : 'bg-white/68 hover:bg-white/88'
                      )}
                    >
                      ...
                      {currentView === item.id && !shouldAnimateShell && (
                        <div className="absolute inset-0 rounded-[24px] border border-slate-950" />
                      )}
                      <div
                        className={cn(
                          'relative flex h-12 w-12 shrink-0 items-center justify-center rounded-[18px] border transition',
                          currentView === item.id
                      ...
                      <div className="relative min-w-0">
                        ...
                        <div
                          className={cn(
                            'mt-1 max-w-[195px] text-xs leading-5',
                            currentView === item.id ? 'text-slate-300' : 'text-slate-500'
                          )}
                        >
                          {item.description}
                        </div>
                  ...
                  <div className="space-y-3">
                    <div className="premium-strip rounded-[30px] p-4">
                      ...
                      <button
                        ...
                        className="mt-3 w-full rounded-[24px] border border-slate-200 bg-white/92 px-4 py-4 text-left transition hover:border-slate-300 hover:bg-white"
                      >
                    ...
                    <div className="grid gap-3">
                      <button
                        ...
                        className="inline-flex w-full items-center justify-between rounded-[24px] border border-slate-200 bg-white/82 px-4 py-4 text-left transition hover:border-slate-300 hover:bg-white"
                      >
                        <div>
                      ...
                      <button
                        ...
                        className="inline-flex w-full items-center justify-between rounded-[24px] border border-rose-200 bg-[linear-gradient(135deg,rgba(255,241,242,0.95),rgba(255,255,255,0.86))] px-4 py-4 text-left transition hover:border-rose-300 hover:bg-white"
                      >
                        <div>
              ...
              <div className="mt-4 shrink-0 rounded-[32px] border border-white/75 bg-[linear-gradient(180deg,rgba(255,255,255,0.88),rgba(255,255,255,0.72))] p-4 shadow-[0_18px_36px_rgba(15,23,42,0.06)]">
                <button
        ...
        >
          <div className="shell-surface rounded-[36px] px-5 py-5 md:px-7 md:py-7">
            <header className="relative flex flex-col gap-6 overflow-hidden rounded-[28px] border border-white/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.88),rgba(255,255,255,0.72))] px-5 py-5 shadow-[0_18px_40px_rgba(15,23,42,0.05)] md:flex-row md:items-start md:justify-between md:px-6">
              <div className="pointer-events-none absolute inset-y-0 right-0 hidden w-[38%] bg-[radial-gradient(circle_at_top_right,rgba(20,83,232,0.12),transparent_42%),radial-gradient(circle_at_bottom_right,rgba(217,93,116,0.08),transparent_32%)] md:block" />
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="section-kicker">{PRODUCT_BRAND.name} / {activeItem.label}</div>
                  ...
                  <div className="mt-4 inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/92 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">
                    Calm command layer
                  </div>
                </div>
              </div>
      ...
      {!isDesktop && (
        <nav className="mobile-nav-safe fixed inset-x-3 z-50 rounded-[26px] border border-white/78 bg-[rgba(255,252,248,0.92)] px-3 pt-2 shadow-[0_18px_34px_rgba(15,23,42,0.1)] backdrop-blur-xl">
            ...
            >
              {currentView === item.id && shouldAnimateShell && (
                <motion.div
                  ...
                  className="absolute inset-0 rounded-[18px] bg-white shadow-[0_12px_28px_rgba(15,23,42,0.1)]"
