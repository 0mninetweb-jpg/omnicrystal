...
export function TrustStrip({ trustLayer, freshnessSummary, provenanceSummary, className }: TrustStripProps) {
  return (
    <div
      className={cn(
        'grid gap-3 rounded-3xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-600 md:grid-cols-4',
        className
      )}
    >
      <div>
