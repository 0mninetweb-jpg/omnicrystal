...
| Sports parity closed | Green | probe_artifact=C:\Users\Fiorenza\OneDrive\Desktop\Codex\crystal-review-0316\docs\sports-probe-2026-04-01.json, winner_mismatch_rate=0, missing_binary_contract_rate=0, a29_ready=True, b36_ready=True |
| Sports calibration artifact | Info | sample_size=0, brier_score=, log_loss=, no_bet_rate= |
...
| check:provider-foundation | passed | 0 |  > react-example@0.0.0 check:provider-foundation > node scripts/check-provider-foundation.mjs  [dotenv@17.3.1] injecting env (39) from functions\.env.omnicrystal -- tip: ⚙️  sup... |
...
| check:domain-quality-grid | passed | 0 |  > react-example@0.0.0 check:domain-quality-grid > node scripts/check-domain-quality-grid.mjs  [dotenv@17.3.1] injecting env (39) from functions\.env.omnicrystal -- tip: 🛠️  ru... |
...
| report:sports-calibration | failed | 1 | npm.cmd : fetch failed  In C:\Users\Fiorenza\OneDrive\Desktop\Codex\crystal-review-0316\scripts\run-phase-a-closeout.ps1:234 car:67  + ... sports-calibration" -Script { npm.cmd ... |
| report:domain-quality-grid | passed | 0 |  > react-example@0.0.0 report:domain-quality-grid > node scripts/run-domain-quality-report.mjs  [dotenv@17.3.1] injecting env (39) from functions\.env.omnicrystal -- tip: 🛡️ au... |
...
- Policy report: `C:\Users\Fiorenza\OneDrive\Desktop\Codex\crystal-review-0316\docs\policy-quality-report-2026-04-01.md`
- Markets report: `C:\Users\Fiorenza\OneDrive\Desktop\Codex\crystal-review-0316\docs\markets-quality-report-2026-04-01.md`
- Provider foundation report: `C:\Users\Fiorenza\OneDrive\Desktop\Codex\crystal-review-0316\docs\provider-foundation-report-2026-04-01.md`
- Domain quality matrix: `C:\Users\Fiorenza\OneDrive\Desktop\Codex\crystal-review-0316\docs\domain-quality-matrix-2026-04-01.md`
