# Markets Quality Report - 2026-03-29
...
### macro_markets
- Cases: `3`
- Used sources: `eurostat_api`, `polymarket_public`, `world_bank_api`, `google_trends`, `historical-cache`, `yahoo_finance`
- Missing required sources: none
- Missing optional sources: `fred_api`

## Regression vs Previous Report
- Previous report: `markets-quality-report-2026-03-28.json`
...
| macro_markets | Will ECB rates fall by autumn? | A.14.macro_economy_and_cycles | ready | eurostat_api, polymarket_public, world_bank_api, google_trends, historical-cache | fred_api | Lean Yes 57/43 |
| macro_markets | Inflation in Italy next 12 months | A.14.macro_economy_and_cycles | ready | eurostat_api, world_bank_api, google_trends, historical-cache | fred_api | Macro market pressure remains elevated over the selected window, with rates and liquidity still shaping the read. |
