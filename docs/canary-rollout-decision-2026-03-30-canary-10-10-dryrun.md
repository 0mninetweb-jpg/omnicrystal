...
## Current Verdict
- Requested stage: **canary-10-10**
- Target rollout: **10/10**
- Action taken: **hold**
...
| current_rollout_stage_ok | Green | Current rollout stage: canary-10-0; expected previous stage: canary-10-0. |
| window_requirement_met | Blocked | Elapsed since current rollout change: 3.85 h; required: 24 h. |
| signed_in_request_threshold | Blocked | Signed-in remote completed runs: 0; required: 20. |
...
- Window start: 2026-03-29T16:25:07.014Z
...
- Current stage target: **Expand canary to 10/10**
- Next stage after this one: **rollout-25-25**
